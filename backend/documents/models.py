...
class UploadFile(models.Model):
    ...
    file_base64 = models.TextField(verbose_name="Файл у Base64")  # тут зберігаємо закодовані дані
    file_extension = models.CharField(max_length=10, verbose_name="Розширення файлу")
