...
from .views import get_issue_complaints, get_gm_solutions, get_complaint_series_by_order, get_order_delivery_address, ReclamationViewSet, get_claim_files, preview_complaint_file, generate_media_token_view
...
urlpatterns = [
    ...
    path('delivery-address/<str:order_number>/', get_order_delivery_address, name='get_order_delivery_address'),
