      ...
      <div className="md:hidden flex flex-col w-full p-3 bg-white rounded-lg shadow-sm border border-gray-200"
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <div className={`font-size-12 font-weight-medium ${getStatusClass(order.status)}`}>
              {order.status}
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mb-2 pb-2 border-b border-gray-200">
          <div className="text-danger font-size-12">{order.date}</div>
          <div className="flex items-center gap-1.5">
            <span className="icon-layout5 font-size-16 text-info"></span>
            <span className="font-size-14 text-danger font-weight-medium">{order.count} конст.</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 mb-2">
          <div className="flex flex-col">
            ...
            <div className="text-info font-size-15 font-weight-bold">
          ...
          <div className="flex flex-col">
            ...
            <div className="text-danger font-size-15 font-weight-bold">
        ...
        <div className="flex items-center gap-1.2 p-1.5 bg-gray-50 rounded mb-2"
          ...
          <div className="font-size-12 text-grey">{order.name}.pdf</div>
        </div>
