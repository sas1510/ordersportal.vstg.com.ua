...
export default function HeaderWithoutAuth() {
  ...
  return (
      ...
      <div className="w-full max-w-[1334px]  h-2 md:h-[12px]  bg-[#B4D947] rounded-t-sm" style={{ backgroundColor: 'var(--header-decorative)' }} />


      <div className="w-full max-w-[1334px] h-12 md:h-[70px] flex items-center justify-between shadow-sm  px-4 md:px-8" style={{ backgroundColor: 'var(--header-bg)' }}>
