...
// --- НОВИЙ ІМПОРТ ---
import ConfirmModal from "./ConfirmModal"; // Використовуємо ваш універсальний компонент
// --------------------
...
export default React.memo(function  OrderItemSummaryMobile ({ order }) {
    ...
    // --- НОВИЙ ОБРОБНИК: Відкриття підтвердження ---
    ...
    // --- НОВИЙ ОБРОБНИК: Відправка підтвердження API ---
    ...
    return (
        <div className="order-item flex flex-col w-full gap-0">
            ...
            <div className="md:hidden flex flex-col w-full p-3 bg-white rounded-lg shadow-sm border border-gray-200"
                ...
                <div className="flex gap-2 overflow-x-auto pb-1.5 py-[2px] -mx-3 px-3 mobile-buttons-scroll"
                    ...
                    <button 
                        ...
                        onClick={openConfirmModal} // <-- ПРИВ'ЯЗКА
                    >
                        Підтвердити
                    </button>
            ...
            {/* 1. Універсальна Модалка Підтвердження */}
            <ConfirmModal
                isOpen={isConfirmModalOpen}
                onClose={() => setIsConfirmModalOpen(false)}
                onConfirm={handleConfirmOrder} // Обробник API
