  ...
  const getDateStatus = useCallback(
    (plannedStr, actualStr) => {
      ...
      if (planned && planned < today)
        return { icon: "text-danger", bg: "background-danger-light" }; // прострочено (змінив bg на більш агресивний)
        ...
        <ul className="timeline-list">
          ...
          <li>
            ...
            <div className="badge">
              ...
              <div
                className={`badge-content ${paymentIsDue ? "background-danger-light" : "background-success-light"}`}
              >
                {paymentIsDue
