...
//   const [telegramContact, setTelegramContact] = useState(null);
//   const [supportChatContact, setSupportChatContact] = useState(null);
...
//         t("emergency.notifications.fill_required"),
//         "warning"
//       );
//     }
...
//       phone,
//       email,
//       telegram_id: newContact.telegramId,
//       department,
//     };
...
//     if (!supportChatContact || isSending) return;

//     if (!supportMessage.trim() && !supportFile) {
...
//       formData.append("text", supportMessage.trim());
//       formData.append("contactId", supportChatContact.id);
//       formData.append(
//         "clientName",
//         user?.full_name || user?.username || t("emergency.unknown_user")
//       );
//       formData.append("messageType", detectMessageType(supportFile));
...
//       addNotification("Повідомлення менеджеру відправлено в Telegram", "success");
...
//             <div key={contact.id} className="emergency-contact-item">
//               <div className="emergency-column">
//                 <div className="emergency-text-info">
...
//                 <button
//                   onClick={() => setSupportChatContact(contact)}
//                   className="emergency-button-call"
//                   disabled={isSending}
//                 >
//                   Чат
...
//                 <h3>
//                   {editingContact
//                     ? `✏️ ${t("emergency.modal.edit_title")}`
//                     : `➕ ${t("emergency.modal.add_title")}`}
//                 </h3>
...
//         {supportChatContact && (
//           <div
//             className="emergy-modal-overlay"
//             onClick={() => !isSending && setSupportChatContact(null)}
//           >
//             <div
//               className="emergy-modal-window"
//               onClick={(e) => e.stopPropagation()}
...
//                 <button
//                   className="emergy-close-btn"
//                   onClick={() => setSupportChatContact(null)}
//                   disabled={isSending}
//                 >
//                   ✕
//                 </button>
...
//                   Повідомлення буде відправлено менеджеру в Telegram.
//                 </p>
...
//                       Додано файл: <b>{supportFile.name}</b>
//                       <button
//                         type="button"
//                         onClick={() => setSupportFile(null)}
//                         className="emerg-btn-cancel ml-3"
//                         disabled={isSending}
//                       >
//                         Прибрати
//                       </button>
...
//                 <div className="emergy-modal-footer mt-4">
//                   <button
//                     type="button"
//                     className="emergency-btn-cancel"
//                     onClick={() => setSupportChatContact(null)}
...
//                     disabled={
//                       isSending || (!supportMessage.trim() && !supportFile)
//                     }
//                   >
...
//                 {t("emergency.modal.delete_confirm_text")}
//               </p>
