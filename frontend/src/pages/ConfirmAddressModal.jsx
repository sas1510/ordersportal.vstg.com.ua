      ...
      >
        <div className="new-calc-modal-border-top">
          <div className="new-calc-modal-header">
            ...
            <h3 style={{ margin: 0, marginLeft: "10px", fontSize: "18px" }}>
              Підтвердження
            </h3>
        ...
        >
          ...
          >
            <div style={{ marginBottom: "8px" }}>
              <strong style={{ color: "#76b448" }}>Адреса на карті:</strong>
              <br />
              <span>{addressName || "Не визначено"}</span>
            </div>
            <div>
              <strong style={{ color: "#76b448" }}>Координати:</strong>
              <br />
              <code>
                {coordinates
