...
// // const videos = [
// //   "https://www.tiktok.com/@viknastyle/video/7634467344730852615?is_from_webapp=1&sender_device=pc&web_id=7573615727900460600",
// //   "https://www.tiktok.com/@viknastyle/video/7624534122479947028?embed_source=121374463%2C121468991%2C121439635%2C121749182%2C121433650%2C121404359%2C121497414%2C122221973%2C122122240%2C121351166%2C121811500%2C121960941%2C122122244%2C122122243%2C122122242%2C121487028%2C122258714%2C121331973%2C120811592%2C120810756%2C121885509%3Bnull%3Bembed_head&refer=embed&referer_url=172.17.19.107%2F&referer_video_id=7536228535598386488",
// //   "https://www.tiktok.com/@viknastyle/video/7623016569790024981",
// //   "https://www.tiktok.com/@viknastyle/video/7536228535598386488",
// //   "https://www.tiktok.com/@viknastyle/video/7621226321510681877",
...
// //           className="hero-text-block"
// //         >
// //           <div className="hero-welcome">{t('welcome')}</div>
...
//   // Статика (числа залишаємо, лейбли перекладаємо)
//   const statsData = [
//     { id: 1, image: "/assets/icons/award-icon.png", value: "18+", label: t('stats.experience'), isJSX: false },
//     { id: 2, image: "/assets/icons/people-icon.png", value: "500+", label: t('stats.employees'), isJSX: false },
//     { id: 3, image: "/assets/icons/factory-icon.png", value: "16 000", label: t('stats.area'), isJSX: true },
//     { id: 4, image: "/assets/icons/window-icon.png", value: "35 000", label: t('stats.windows_monthly'), isJSX: false },
//   ];

//   const statCards = [
//     { id: "window", icon: windowIcon, value: "35 000", label: t('production.pvc_windows'), bgClass: "absolute top-[180px] left-[427px] w-[279px] h-[180px] bg-white rounded-sm shadow-sm", valueClass: "left-[427px] absolute top-[270px] w-[279px] font-black text-[#44403E] text-[40px] text-center z-10", labelClass: "top-[323px] left-[427px] w-[279px] font-normal text-[22px] text-center absolute text-[#44403E] z-10", iconClass: "absolute top-[207px] left-[542px] w-[50px] h-[50px] z-10" },
//     { id: "door", icon: doorIcon, value: "9 000", label: t('production.pvc_doors'), bgClass: "absolute top-[180px] left-[734px] w-[279px] h-[180px] bg-white rounded-sm shadow-sm", valueClass: "left-[734px] absolute top-[270px] w-[279px] font-black text-[#44403E] text-[40px] text-center z-10", labelClass: "top-[323px] left-[734px] w-[279px] font-normal text-[22px] text-center absolute text-[#44403E] z-10", iconClass: "absolute top-[207px] left-[862px] w-[24px] h-[50px] z-10" },
//     { id: "cycle", icon: cicleIcon, value: "Full Cycle", label: t('production.innovations'), bgClass: "absolute top-[180px] left-[1041px] w-[279px] h-[180px] bg-white rounded-sm shadow-sm", valueClass: "absolute top-[270px] left-[1041px] w-[279px] font-black text-[#44403E] text-[40px] text-center z-10", labelClass: "top-[323px] left-[1041px] w-[279px] font-normal text-[22px] text-center absolute text-[#44403E] z-10", iconClass: "absolute top-[207px] left-[1156px] w-[49px] h-[50px] z-10" },
//   ];

//   const infoItems = [
//     { icon: plantIcon, iconClass: "absolute top-[15px] left-[202px] w-[49px] h-[50px] object-cover", textClass: "top-[15px] left-[269px] w-[478px] text-xl absolute text_[#44403E] leading-tight", text: t('info.factory_location') },
//     { icon: exportIcon, iconClass: "absolute top-[15px] left-[765px] w-[50px] h-[50px] object-cover", textClass: "top-[15px] left-[844px] w-[367px] text-xl absolute text-[#44403E] leading-tight", text: t('info.export_geography') },
//   ];

//   const features = [
//     { id: 1, icon: aesteticIcon, title: t('values.aesthetics.title'), description: t('values.aesthetics.desc'), mdLeft: "md:left-0", mobileOrder: "max-md:order-1", iconClass: "w-[93px] h-[80px]" },
//     { id: 2, icon: qualityIcon, title: t('values.quality.title'), description: t('values.quality.desc'), mdLeft: "md:left-[25.5%]", mobileOrder: "max-md:order-3", iconClass: "w-[85px] h-[100px]" },
//     { id: 3, icon: costIcon, title: t('values.price.title'), description: t('values.price.desc'), mdLeft: "md:left-[51.1%]", mobileOrder: "max-md:order-4", iconClass: "w-[90px] h-[80px]" },
//     { id: 4, icon: safetyIcon, title: t('values.safety.title'), description: t('values.safety.desc'), mdLeft: "md:left-[76.7%]", mobileOrder: "max-md:order-2", iconClass: "w-[86px] h-[100px]" },
//   ];

//   const videos = [
//     "https://www.tiktok.com/@viknastyle/video/7634467344730852615",
//     "https://www.tiktok.com/@viknastyle/video/7624534122479947028",
//     "https://www.tiktok.com/@viknastyle/video/7623016569790024981",
//     "https://www.tiktok.com/@viknastyle/video/7536228535598386488",
//     "https://www.tiktok.com/@viknastyle/video/7621226321510681877",
//     "https://www.tiktok.com/@viknastyle/video/7618147133090286869",
...
//     visible: (idx) => ({
//       opacity: 1, y: 0,
//       transition: { duration: 1.2, delay: idx * 0.3, ease: [0.25, 0.1, 0.25, 1] },
//     }),
//   };
...
//       {/* Hero Section */}
//       <section className="hero-section">
//         <video autoPlay loop muted playsInline className="hero-video-bg" poster="/assets/video/hero-poster.jpg">
//           <source src="/assets/video/hero-background-1.webm" type="video/webm" />
//           <source src="/assets/video/hero-background-1.mp4" type="video/mp4" />
//         </video>
//         <div className="hero-overlay"><div className="hero-gradient"></div></div>
//         <div className="hero-content">
//           <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.8 }} className="hero-text-block">
//             <div className="hero-welcome">{t('hero.welcome')}</div>
//             <h1 className="font-['Inter'] font-[1000] text-[24px] md:text-[40px] leading-[100%] text-center text-white">
...
//           <div className="stats-grid grid grid-cols-2 md:flex md:flex-row md:justify-center gap-4 md:gap-10 px-4">
//             {statsData.map((stat, idx) => (
//               <motion.div key={stat.id} className="stat-card flex flex-col items-center text-center" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={idx}>
//                 <div className="stat-image-wrapper mb-2 md:mb-4">
//                   <img src={stat.image} alt="" className="stat-custom-img w-[50px] h-[50px] md:w-[80px] md:h-[80px] object-contain" />
//                 </div>
//                 <div className="stat-value font-black text-[24px] md:text-[40px] text-white">
//                   {stat.isJSX ? <span className="flex items-baseline gap-1">16 000 <small className="text-[14px] md:text-[20px]">м²</small></span> : stat.value}
//                 </div>
//                 <div className="stat-label font-normal text-[12px] md:text-[18px] text-white opacity-90">{stat.label}</div>
//               </motion.div>
//             ))}
//           </div>

//           <motion.div animate={{ y: [0, 10, 0] }} transition={{ repeat: Infinity, duration: 2 }} className="scroll-indicator flex justify-center w-full mb-15 ">
//             <img src={Polygon} alt="" className="w-[55px] h-[27px] object-contain" />
//           </motion.div>
//         </div>
//       </section>

//       {/* Production Capacities Section */}
//       <section className="w-full bg-[#F0F4DB] py-12 px-4 overflow-hidden">
//         <div className="max-w-[1440px] mx-auto">
//           <motion.h2 className="font-[900] text-[24px] md:text-[32px] text-[#44403E] text-center mb-12 uppercase" style={{ WebkitTextStroke: '1px #44403E' }}>
//             {t('production.title')}
//           </motion.h2>
...
//                   <p className="text-[#44403E]">{item.text}</p>
//                 </div>
//               ))}
//               <h3 className="font-[900] text-[24px] text-[#44403E] text-center uppercase" style={{ WebkitTextStroke: '1px #44403E' }}>{t('production.cycle_title')}</h3>
//               {statCards.map((card) => (
//                 <div key={card.id} className="bg-white p-4 rounded shadow-sm flex items-center gap-4">
//                   <img src={card.icon} className="w-10 h-10 object-contain" alt="" />
//                   <div>
//                     <div className="font-black text-xl">{card.value}</div>
//                     <div className="text-xs opacity-70 uppercase">{card.label}</div>
//                   </div>
//                 </div>
//               ))}
//             </div>
...
//               <div className="absolute top-[180px] left-[50px] w-[279px] font-black text-[32px] text-center text-[#44403E] uppercase" style={{ WebkitTextStroke: '1px #44403E' }}>
//                 {t('production.cycle_title_br')}
//               </div>
//               {statCards.map((card, index) => (
//                 <motion.div key={card.id} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={index}>
//                   <div className={card.bgClass} />
//                   <img className={card.iconClass} src={card.icon} alt="" />
//                   <div className={card.valueClass}>{card.value}</div>
//                   <div className={card.labelClass}>{card.label}</div>
//                 </motion.div>
//               ))}
//               {infoItems.map((item, index) => (
//                 <motion.div key={index} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={index}>
...
//       {/* Values Section */}
//       <section className="w-full py-10 md:py-24 flex justify-center bg-white px-4">
//         <div className="max-w-[1201px] w-full grid grid-cols-2 md:flex md:justify-between gap-y-12">
//           {features.map((feature, index) => (
//             <motion.div key={feature.id} variants={fadeUp} initial="hidden" whileInView="visible" custom={index} className="flex flex-col items-center text-center px-2">
//               <div className="h-[100px] flex items-end mb-4">
//                 <img src={feature.icon} className="object-contain" alt="" />
//               </div>
//               <div className="font-black text-lg md:text-2xl text-[#44403E] uppercase mb-2">{feature.title}</div>
//               <div className="text-sm md:text-lg text-[#44403E] opacity-80">{feature.description}</div>
//             </motion.div>
//           ))}
//         </div>
//       </section>
...
//       <section className="media-section py-20 bg-[#3D3834]">
//         <div className="max-w-8xl mx-auto px-12 relative">
//           <h2 className="text-center text-2xl md:text-3xl font-bold text-white mb-10">{t('media.title')}</h2>
//           <button onClick={() => scrollByManual(-340)} className="absolute left-0 top-[60%] z-20"><img src="/assets/icons/chevron-left.png" className="w-6 opacity-50 hover:opacity-100" alt="" /></button>
//           <button onClick={() => scrollByManual(340)} className="absolute right-0 top-[60%] z-20"><img src="/assets/icons/chevron-right.png" className="w-6 opacity-50 hover:opacity-100" alt="" /></button>
//           <div ref={containerRef} className="media-slider flex gap-6 overflow-x-auto no-scrollbar">
//             {videos.map((url, i) => (
//               <div key={i} className="flex-shrink-0 w-[300px] aspect-[9/16]">
//                 <iframe src={`https://www.tiktok.com/embed/v2/${url.split("/video/")[1]?.split("?")[0]}`} className="w-full h-full" allowFullScreen sandbox="allow-scripts allow-same-origin allow-popups"></iframe>
//               </div>
//             ))}
//           </div>
//         </div>
...
//       {/* Partnership Section */}
//       <motion.section className="w-full pt-10 pb-20 flex justify-center bg-white border-t-4 border-[#B4D947]" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
//         <div className="max-w-[1203px] text-center px-4">
//           <img src={handshake} className="w-[100px] mx-auto mb-6" alt="" />
//           <h2 className="font-black text-2xl md:text-3xl text-[#44403E] uppercase mb-4 leading-tight">
//             {t('partnership.title_line1')} <br /> {t('partnership.title_line2')}
//           </h2>
//           <p className="text-lg md:text-xl text-[#44403E] max-w-3xl mx-auto leading-relaxed">
//             {t('partnership.desc_line1')} <br /> {t('partnership.desc_line2')}
//           </p>
//         </div>
//       </motion.section>
//     </div>
